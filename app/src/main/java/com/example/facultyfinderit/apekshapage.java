...
public class apekshapage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apekshapage);
        ...
        rl = (RecyclerView) findViewById(R.id.apeksharecyclerview) ;
        rl.setAdapter(adapter);
        rl.setLayoutManager(new LinearLayoutManager(apekshapage.this));


        ArrayAdapter spinneradapter = new ArrayAdapter<String>(apekshapage.this, R.layout.support_simple_spinner_dropdown_item, days);
        ...
        daysspinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(apekshapage.this,"Please select a day ",Toast.LENGTH_SHORT).show();;
            }
        });
