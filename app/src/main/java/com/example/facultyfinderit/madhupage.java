...
public class madhupage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_madhupage);
        ...
        rl = (RecyclerView) findViewById(R.id.madhurecyclerview) ;
        rl.setAdapter(adapter);
        rl.setLayoutManager(new LinearLayoutManager(madhupage.this));


        ArrayAdapter spinneradapter = new ArrayAdapter<String>(madhupage.this, R.layout.support_simple_spinner_dropdown_item, days);
        ...
        daysspinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(madhupage.this,"Please select a day ",Toast.LENGTH_SHORT).show();;
            }
        });
