...
public class stephypage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stephypage);
        ...
        rl = (RecyclerView) findViewById(R.id.stephyrecyclerview) ;
        rl.setAdapter(adapter);
        rl.setLayoutManager(new LinearLayoutManager(stephypage.this));


        ArrayAdapter spinneradapter = new ArrayAdapter<String>(stephypage.this, R.layout.support_simple_spinner_dropdown_item, days);
        ...
        daysspinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(stephypage.this,"Please select a day ",Toast.LENGTH_SHORT).show();;
            }
        });
