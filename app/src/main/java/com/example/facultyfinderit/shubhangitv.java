...
public class shubhangitv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shubhangitv);
        ...
        days.add("Saturday");
        days.add("Sunday");
        mondaylecturesArrayList.add(new Lectures("9AM - 10AM","BE LAB (A2)","T-302"));
        mondaylecturesArrayList.add(new Lectures("10AM - 11AM","BE LAB (A2)","T-302"));
        mondaylecturesArrayList.add(new Lectures("11AM - 12PM","OFF LECTURE","R-103"));
        mondaylecturesArrayList.add(new Lectures("12PM - 1PM","OFF LECTURE","R-103"));
        mondaylecturesArrayList.add(new Lectures("1PM- 2PM","BE LAB (B3)","T-302"));
        mondaylecturesArrayList.add(new Lectures("2PM - 3PM","BE LAB (B3)","T-302"));
        mondaylecturesArrayList.add(new Lectures("3PM - 4PM","PC (IT B)","R-103"));
        mondaylecturesArrayList.add(new Lectures("4PM - 5PM","OFF LECTURE","R-103"));
        mondaylecturesArrayList.add(new Lectures("5PM - 6PM","OFF LECTURE","R-103"));
        ...
        rl = (RecyclerView) findViewById(R.id.shubhangirecyclerview) ;
        rl.setAdapter(adapter);
        rl.setLayoutManager(new LinearLayoutManager(shubhangitv.this));


        ArrayAdapter spinneradapter = new ArrayAdapter<String>(shubhangitv.this, R.layout.support_simple_spinner_dropdown_item, days);
        ...
        daysspinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(shubhangitv.this,"Please select a day ",Toast.LENGTH_SHORT).show();;
            }
        });
